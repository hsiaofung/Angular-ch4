...
describe('Product Item Component', () => {
  ...
  it('should render the product correctly', () => {
    // We add these CSS classes to the component templates as well
    ...
    expect(priceEl.nativeElement.textContent).toEqual(
  ...
  it('should handle quantity increment correctly', () => {
    ...
    const incrementBtnEl = fixture.debugElement.query(
  ...
  it('should handle quantity decrement correctly', () => {
    ...
    const decrementBtnEl = fixture.debugElement.query(
